...
<li><a href = "index.php">Home</a></li> |
		...
		<li><a href = "dineandlounge.php">cena y salón</a></li> |			
		<li><a href = "reservation.php">Reserva</a></li> |
		<li><a href = "rulesandregulation.php">Reglas</a></li>
	</ul>
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<strong><h3>Realizar una Reservacion</h3></strong>
				<?php
				...
				?>
					<div class = "well" style = "height:300px; width:100%;">
						...
						<div style = "float:left; margin-left:10px;">
							...
							<br /><br /><br /><br /><br /><br />
							<a style = "margin-left:580px;" href = "add_reserve.php?room_id=<?php echo $fetch['room_id']?>" class = "btn btn-info"><i class = "glyphicon glyphicon-list"></i> Reserva</a>
						</div>
					</div>
				<?php
					}
