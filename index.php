...
<html lang = "en">
	<head>
		<title>Sistema de Reservaciones de Hotel en Linea</title>
		<meta charset = "utf-8" />
...
<body>
	...
	<ul id = "menu">
		...
		<li><a href = "dineandlounge.php">Cena y Salon</a></li> |			
		<li><a href = "reservation.php">Reservar</a></li> |
	...
	<div id="myCarousel" class="carousel slide container-fluid" data-ride="carousel">
		...
		<div style = "margin:auto;" class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/logo.JPEG" style = "width:100%; height:450px;" />
			</div>
