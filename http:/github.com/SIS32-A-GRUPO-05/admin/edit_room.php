...
<body>
	...
	<div class = "container-fluid">
		<ul class = "nav nav-pills">
			...
			<li><a href = "reserve.php">Reservaciones</a></li>
	...
	<div class = "container-fluid">
		<div class = "panel panel-default">
			<div class = "panel-body">
				<div class = "alert alert-info">Transaccion / Habitacion / Edicion de habitacion</div>
				<br />
				<div class = "col-md-4">
					<?php
					...
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<select class = "form-control" required = required name = "room_type">
								...
								<option value = "Ejecutiva" <?php if($fetch['room_type'] == "Executive Suite"){echo "selected";}?>>Executive Suite</option>
							</select>
						</div>
						<div class = "form-group">
							<label>Precio </label>
